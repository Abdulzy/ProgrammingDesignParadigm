...
/**
 * Reptile class that consist of characteristics of the reptile.
 */
public class Reptile implements Animal {
  ...
  /**
   * Creates a reptile object with the information about the reptile.
   *
   * @param name                   Species name of reptile.
   * @param description            characteristics of reptile.
   * @param size                   Size of reptile.
   * @param feature                Natural feature of reptile.
   * @param lowerTemperatureRange  Lower temperature range of reptile.
   * @param higherTemperatureRange higher temperature range of reptile.
   * @param poisonous              If the animal is poisonous.
   * @param survivalState          Survival state of the reptile.
   * @param shareSpace             If animal can co exist.
   * @throws IllegalArgumentException If size of the reptile is negative.
   * @throws IllegalArgumentException If size of the reptile greater than 3.
   ...
   */
  public Reptile(String name, String description, int size, String feature,
   ...
   * @return The toString of the reptile class.
   */
  @Override
  public String toString() {
    return String.format("The %s, a reptile. %s. "
                    + "Also it is %s for being poisonous,"
                    + " %s for being extinct and %s for being endangered.",
            animalName, animalCharacteristics, poison, checkExtinct(), checkEndangered());
  }
}
