...
public class ReptileTest {
  ...
  @Before
  public void setUp() {
    abdul = new Reptile(" sNaKe ", "it has no legs", 1, " ForEst ", -20, 25, false, 3, true);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNull() {
    abdul = new Reptile(" sNaKe ", null, -1, " ForEst ", -20, 25, false, 4, true);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testIfNegative() {
    abdul = new Reptile(" sNaKe ", "it has no legs", -1, " ForEst ", -20, 25, false, 4, true);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testOverRange() {
    abdul = new Reptile(" sNaKe ", "it has no legs", 4, " ForEst ", -20, 25, false, 4, true);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testStringLength() {
    abdul = new Reptile("", "it has no legs", 1, " ForEst ", -20, 25, false, 4, true);
  }
  ...
  public void testingOtherSizes() {
    abdul = new Reptile(" sNaKe ", "it has no legs", 2, " ForEst ", -20, 25, false, 3, true);
    Animal vic = new Reptile(" sNaKe ", "it has no legs", 3, " ForEst ", -20, 25, false, 3, true);
  ...
  public void testingToString() {
    assertEquals("toString passed", "The snake, a reptile. it has no legs."
