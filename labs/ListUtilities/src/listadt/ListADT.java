...
public interface ListADT<T> {
  ...
  /**
   * A general purpose filter higher order function on this list, that returns the
   * corresponding list that match the given predicate.
   *
  ...
  /**
   * A general purpose fold higher order function on this list, that returns the
   * corresponding value of the operation.
